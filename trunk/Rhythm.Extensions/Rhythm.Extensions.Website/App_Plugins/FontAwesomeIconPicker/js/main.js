...
require.config({
	'paths' : {
		...
		'jquery.mousewheel' : 'components/selectik/src/jquery.mousewheel',
		'jquery.selectik' : 'components/selectik/src/jquery.selectik'
	},
	'shim' : {
		'jquery.mousewheel': {
			'deps' : ['jquery']
...
require(['jquery', 'jquery.selectik'], function ($) {
	$(function () {
